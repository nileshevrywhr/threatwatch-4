                ...
                <Card className="glass border-orange-400/30">
                  <CardHeader>
                    <CardTitle className="text-xl text-white flex items-center space-x-2">
                      ...
                      <span>Quick Scan Results: {quickScanResult.query}</span>
                    </CardTitle>
                    <CardDescription className="text-gray-400">
                      Latest threat intelligence powered by AI analysis
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-800/50 rounded-lg p-4">
                        <pre className="text-gray-300 text-sm whitespace-pre-wrap font-sans leading-relaxed">
                          {quickScanResult.summary}
                        </pre>
                      </div>
                    </div>

                    {/* Key Threats */}
                    {quickScanResult.key_threats && quickScanResult.key_threats.length > 0 && (
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-3">Key Threats Identified</h4>
                        <div className="grid gap-2">
                          {quickScanResult.key_threats.map((threat, index) => (
                    ...
                    {/* Sources */}
                    {quickScanResult.sources && quickScanResult.sources.length > 0 && (
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-3">Intelligence Sources</h4>
                        <div className="grid gap-2">
                          {quickScanResult.sources.slice(0, 3).map((source, index) => (
                    ...
                    <div className="bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border border-cyan-500/30 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h5 className="text-white font-semibold">Want continuous monitoring?</h5>
                          <p className="text-gray-400 text-sm">Set up automated alerts for "{quickScanResult.query}" threats</p>
                        </div>
                        <Button
                          onClick={() => {
                            setFormData({...formData, term: quickScanResult.query});
                            setQuickScanResult(null);
                          }}
